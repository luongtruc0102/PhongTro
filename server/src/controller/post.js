...
export const getPosts = async(req, res) => {
    try {
        ...
        return res.status(500).json({
            err: -1,
            msg: 'Fail post at controller Post: ' + error
        })
    }
}
...
export const getPostsLimit = async(req, res) => {
    ...
    try {
        ...
        return res.status(500).json({
            err: -1,
            msg: 'Fail post at controller PostLimit: ' + error
        })
    }
}
...
export const getNewPosts = async(req, res) => {
    try {
        ...
        return res.status(500).json({
            err: -1,
            msg: 'Fail post at controller newPost: ' + error
        })
    }
}
...
export const createNewPost = async(req, res) => {
    try {
        ...
        return res.status(500).json({
            err: -1,
            msg: 'Fail post at controller createNewPost: ' + error
        })
    }
}
...
export const getPostsLimitAdmin = async(req, res) => {
    ...
    try {
        ...
        return res.status(500).json({
            err: -1,
            msg: 'Fail post at controller PostLimitAdmin: ' + error
        })
    }
}
...
export const updatePost = async(req, res) => {
    ...
    try {
        ...
        return res.status(500).json({
            err: -1,
            msg: 'Fail post at controller updatePost: ' + error
        })
    }
}
...
export const deletePost = async(req, res) => {
    ...
    try {
        ...
        return res.status(500).json({
            err: -1,
            msg: 'Fail post at controller deletePost: ' + error
        })
    }
}